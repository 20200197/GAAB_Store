  ...
  dataset.map(function (row) {
    ...
    content += `
            <tr>
                ...
                <td><img src="${SERVER}imagenes/clientes/${row.imagen_perfil_cliente}" class="materialboxed" height="100"></td>
...
function openReport() {
  ...
  let url = SERVER + "reportes/dashboard/ventas_cliente.php";
    ...
    if (request.ok) {
      ...
      request.json().then(function (response) {
        ...
        if (response.status) {
          ...
          document.getElementById("id_estado_cliente").value =
            response.dataset.id_estado_cliente;
