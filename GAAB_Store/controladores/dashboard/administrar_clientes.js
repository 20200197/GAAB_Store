    ...
    dataset.map(function (row) {
        ...
        content += `
            <tr>
                ...
                <td>
            <a onClick="openCompra(${row.id_cliente})"><img src="../../recursos/img/imagenes/file_35px.png"></td></a>
            <td>
            ...
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    response.dataset.map(function (row) {
                        // if(row.estado_factura=='En proceso'){
                        //     document.querySelectorAll('#estado_factura').style.backgroundColor='blue';
