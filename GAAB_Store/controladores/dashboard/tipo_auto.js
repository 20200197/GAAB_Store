  ...
  dataset.map(function (row) {
    ...
    content += `
            <tr>
                ...
                <td>
            <a onClick="openUpdate(${row.id_tipo_auto})" ><img src="../../recursos/img/imagenes/file_35px.png"></td></a>
            <td>
            <a onClick="openDelete(${row.id_tipo_auto})"><img src="../../recursos/img/icono/eliminar_ico_25px.png"></a></td>
            </tr>
        `;
  });
...
function openReport() {
  ...
  let url = SERVER + "reportes/dashboard/productos_vendidos.php";
    ...
    if (request.ok) {
      ...
      request.json().then(function (response) {
        ...
        if (response.status) {
          ...
          document.getElementById("tipo_auto").value =
            response.dataset.tipo_auto;
        } else {
...
function openDelete(id) {
  ...
  document.getElementById("texto_dos").textContent =
    "¿Está seguro de eliminar este tipo de auto?";
}
