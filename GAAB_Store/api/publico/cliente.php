        ...
        switch ($_GET['action']) {
            ...
            case 'editProfile':
                ...
                if (!$data = $cliente->readOnes()) {
                    ...
                    //Evaluamos que no se repita el telefono
                }  elseif ($cliente->readD('telefono_cliente', $cliente->getTelefono())) {
                    ...
                    //Evaluamos que no se repita el correo
                } elseif ($cliente->readD('correo_cliente', $cliente->getCorreo())) {
