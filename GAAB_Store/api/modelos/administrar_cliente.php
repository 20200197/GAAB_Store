...
class Clientes extends Validator
{
    ...
    */
    ...
    public function checkPassword($contrasenia)
    {
    ...
    {
        $sql = 'SELECT id_cliente, nombre_cliente, apellido_cliente, telefono_cliente, usuario_cliente, contrasenia, imagen_perfil_cliente, correo_cliente, dui_cliente, estado_cliente
    ...
    {
        $sql = 'UPDATE cliente
                SET nombre_cliente = ?, apellido_cliente = ?, telefono_cliente=?,usuario_cliente=?,contrasenia=?,imagen_perfil_cliente=?,correo_cliente=?,dui_cliente=?,id_estado_cliente=?  
                WHERE id_cliente = ?';
        $params = array($this->nombre, $this->apellido, $this->correo_cliente, $_SESSION['id_cliente']);
        return Database::executeRow($sql, $params);
    }
    ...
    */
    ...
    {
        $sql = 'INSERT INTO cliente(nombre_cliente, apellido_cliente, telefono_cliente, usuario_cliente, contrasenia, imagen_perfil_cliente, correo_cliente, dui_ciente, id_estado_cliente)
                VALUES(?, ?, ?, ?, ?,?,?,?,?)';
    ...
    public function readOne()
    {
        $sql = 'SELECT id_cliente,id_estado_cliente
                FROM cliente 
                WHERE id_cliente = ? and id_estado_cliente = ?';
        $params = array($this->id,$this->id_estado_cliente);
        return Database::getRow($sql, $params);
    }
    ...
    {
        $sql = 'SELECT  cliente.id_cliente,productos.nombre_producto, sum(detalle_factura.cantidad_producto) as cantidad_producto, cliente.id_estado_cliente
        ...
        group  by  productos.nombre_producto, cliente.id_cliente';
        $params = array($this->id);
        return Database::getRows($sql, $params);
    }


    public function updateRowT()
    {
        $sql = 'UPDATE cliente 
