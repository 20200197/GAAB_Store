...
class Clientes extends Validator
{
    ...
    public function editProfile($current_image)
    {
        ...
        $sql = 'UPDATE cliente
                SET nombre_cliente = ?, apellido_cliente = ?, correo_cliente = ?, usuario_cliente = ?, imagen_perfil_cliente = ?, telefono_cliente=?, dui_cliente = ?
                WHERE id_cliente = ?';
        $params = array($this->nombre, $this->apellido, $this->correo,$this->usuario,$this->imagen, $this->telefono, $this->dui,$_SESSION['id_cliente']);
        return Database::executeRow($sql, $params);
    }
